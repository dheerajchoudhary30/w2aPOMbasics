...
public class TestConfig{
	...
	public static String from = "tusharc272@gmail.com";
	public static String password = "1R1S1P0*";
	public static String[] to ={"dheeraj.choudhary30@gmail.com","tusharc272@gmail.com"};
